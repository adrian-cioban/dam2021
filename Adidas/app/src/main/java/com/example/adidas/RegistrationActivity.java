...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private boolean isValid() {
        if (etFirstName.getText().toString().isEmpty()) {
            Toast.makeText(RegistrationActivity.this, "First name field is empty", Toast.LENGTH_SHORT).show();
            return false;
        }
        if (etLastName.getText().toString().isEmpty()) {
            Toast.makeText(RegistrationActivity.this, "Last name field is empty", Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        if (etLocation.getText().toString().isEmpty()) {
            Toast.makeText(RegistrationActivity.this, "Location field is empty", Toast.LENGTH_SHORT).show();
            return false;
        }
        if (etBirthdate.getText().toString().isEmpty()) {
            Toast.makeText(RegistrationActivity.this, "Birthdate field is empty", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
